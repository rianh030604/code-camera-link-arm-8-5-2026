...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/share/dynamixel_hardware_interface/cmake/export_dynamixel_hardware_interfaceExport.cmake")
    ...
    if(EXPORT_FILE_CHANGED)
      ...
      if(OLD_CONFIG_FILES)
        message(STATUS "Old export file \"$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/share/dynamixel_hardware_interface/cmake/export_dynamixel_hardware_interfaceExport.cmake\" will be replaced.  Removing files [${OLD_CONFIG_FILES}].")
